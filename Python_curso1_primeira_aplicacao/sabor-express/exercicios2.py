...
opcao2 = int(input("Digite a sua idade\n"))

if (opcao2 >=0) and (opcao2 <=12):
    print('Você é uma criança')

elif(opcao2 >=13) and (opcao2 <=18):
...
# estrutura if else para verificar se o nome de usuário e
...
# uma estrutura if elif else para determinar em qual quadrante do plano cartesiano
